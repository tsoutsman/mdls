//! Taken from `rust-analyzer/crates/ide-db/src/line_index.rs`
//!
...
impl LineIndex {
    ...
    pub(crate) fn to_utf16(&self, line_col: LineCol) -> LineColUtf16 {
    ...
    pub(crate) fn to_utf8(&self, line_col: LineColUtf16) -> LineCol {
